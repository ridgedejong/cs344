...
problem = {
    ...
    'initial1': ['space on table', 'b on table', 'space on b', 'a on table', 'c on a', 'space on c'],
    'goal1': ['b on table', 'space on b', 'a on table', 'space on a', 'c on table', 'space on c'],
    'initial2': ['a on table', 'space on a', 'b on table', 'space on b', 'c on table', 'space on c'],
